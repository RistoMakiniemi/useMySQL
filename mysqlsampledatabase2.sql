...
CREATE DATABASE IF NOT EXISTS `ictossaaja_mysql`;

/*!USE `classicmodels`*/;
USE `ictossaaja_mysql`;
...
CREATE TABLE `offices` (
  `officeCode` int(11) /*varchar(10)*/ NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `employees` (
  ...
  `officeCode` int(11) /*varchar(10)*/ NOT NULL,
